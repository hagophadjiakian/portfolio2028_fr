      ...
      <AnimatedSection title="My Story" subtitle="From adversity to achievement - a journey of resilience">
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="w-20 h-20 rounded-full bg-gradient-to-br from-coral to-sky p-1">
                    <img
                      src="http://localhost:8000/assets/images/profilepic.jpg"
        ...
        <div className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { src: 'http://localhost:8000/assets/images/diploma.jpg', title: 'Engineering Diploma', icon: '🎓', color: 'coral' },
              { src: 'http://localhost:8000/assets/images/deans.jpg', title: "Dean's List Recognition", icon: '🏆', color: 'hope' },
              { src: 'http://localhost:8000/assets/images/dog.jpeg', title: 'My Companion', icon: '🐕', color: 'sky' },
            ].map((item) => (
          ...
          <AnimatedItem>
            <GlassCard glow glowColor="hope" className="max-w-2xl mx-auto">
              ...
              <div className="rounded-lg overflow-hidden bg-black/50">
                ...
                >
                  <source src="http://localhost:8000/assets/videos/graduation.mp4" type="video/mp4" />
        ...
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { src: 'http://localhost:8000/assets/videos/japan.mp4', title: 'HAL Exoskeleton in Japan', icon: '🇯🇵' },
              { src: 'http://localhost:8000/assets/videos/kafoWalker.mp4', title: 'KAFO Walker Progress', icon: '🚶' },
              { src: 'http://localhost:8000/assets/videos/afo.mp4', title: 'AFO Training Session', icon: '🦿' },
              { src: 'http://localhost:8000/assets/videos/red1.mp4', title: 'Rehabilitation Exercise', icon: '💪' },
              { src: 'http://localhost:8000/assets/videos/red2.mp4', title: 'Recovery Training', icon: '✨' },
            ].map((video, index) => (
